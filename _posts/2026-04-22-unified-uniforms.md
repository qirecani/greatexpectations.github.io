...
$$
\mathbb{P}(x<X_{(k)}\le x+\Delta x)=k\binom{n}{k}\mathbb{P}(X\lex)^{k-1}\mathbb{P}(x<X\le x+\Delta x)\mathbb{P}(X>x)^{n-k}=k\binom{n}{k}\left(F_X(x)\right)^{k-1}\left(1-F_X(x)\right)^{n-k}\cdot\mathbb{P}(x<X\le x+\Delta x).
$$
